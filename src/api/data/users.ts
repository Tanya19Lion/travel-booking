import { User, UserExtended } from '../../lib/types';

export const createUser = (user: User): UserExtended => {
	const { avatarUrl, bio, email, firstName, id, initials, lastName, password } = user;
