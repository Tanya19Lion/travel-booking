...
export const createListing = (listing: Listing): ListingExtended => {
	const {
		availability,
		description,
		guestFavorite,
...
export const isListingAvailable = (listing: Listing, dates: { from: Date; to: Date }) => {
...
export const listings: ListingExtended[] = [
	createListing({
		id: 1,
